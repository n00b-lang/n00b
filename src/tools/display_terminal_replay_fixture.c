...
static int
write_replay_log(const char                                  *out_dir,
                 const n00b_display_terminal_replay_summary_t *summary)
{
    ...
    n = snprintf(text,
                 ...
                 "cursor.hide=%d\n"
                 "cursor.show=%d\n",
                 summary->resize_calls > 0 ? 1 : 0,
                 (int)summary->resize_rows,
                 (int)summary->resize_cols,
                 summary->left_key_events,
                 summary->right_key_events,
                 summary->right_mouse_presses,
                 summary->right_activations,
                 summary->cursor_hide ? 1 : 0,
                 summary->cursor_show ? 1 : 0);
...
write_metadata(const char *out_dir)
{
    ...
    printf("wrote terminal_replay_metadata.txt\n");
    return 0;
}

int
n00b_display_terminal_replay_run(
    n00b_display_terminal_replay_summary_t *summary)
{
    ...
    *summary = (n00b_display_terminal_replay_summary_t){};
    ...
    const n00b_display_terminal_replay_summary_t *summary)
{
    ...
    if (write_replay_log(out_dir, summary) != 0) {
        return -1;
    }
