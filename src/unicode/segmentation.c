...
static inline n00b_unicode_gcb_t get_gcb(n00b_codepoint_t cp) {
  if (cp >= 0x110000)
    return N00B_UNICODE_GCB_OTHER;
  return (n00b_unicode_gcb_t)N00B_UNICODE_LOOKUP(n00b_unicode_gcb_stage1, n00b_unicode_gcb_stage2,
                                       cp);
}

static inline n00b_unicode_wb_t get_wb(n00b_codepoint_t cp) {
  if (cp >= 0x110000)
    return N00B_UNICODE_WB_OTHER;
  return (n00b_unicode_wb_t)N00B_UNICODE_LOOKUP(n00b_unicode_wb_stage1, n00b_unicode_wb_stage2, cp);
}

static inline n00b_unicode_sb_t get_sb(n00b_codepoint_t cp) {
  if (cp >= 0x110000)
    return N00B_UNICODE_SB_OTHER;
  return (n00b_unicode_sb_t)N00B_UNICODE_LOOKUP(n00b_unicode_sb_stage1, n00b_unicode_sb_stage2, cp);
}
...
static bool grapheme_is_break(n00b_unicode_break_iter_t *it, n00b_unicode_gcb_t prev,
...
n00b_unicode_break_iter_t *n00b_unicode_grapheme_iter_raw(const char *data, int64_t len) {
...
n00b_unicode_break_iter_t *n00b_unicode_grapheme_iter(n00b_string_t s) _kargs {
...
int32_t n00b_unicode_break_next(n00b_unicode_break_iter_t *it) {
  ...
  if (it->type == N00B_UNICODE_BREAK_GRAPHEME) {
    ...
    while (it->byte_pos < (uint32_t)it->len) {
      ...
      bool cur_ahletter =
          (cur_wb == N00B_UNICODE_WB_ALETTER || cur_wb == N00B_UNICODE_WB_HEBREW_LETTER);
      bool cur_midletter =
...
void n00b_unicode_break_iter_free(n00b_unicode_break_iter_t *it) { n00b_free(it); }

// ---------------------------------------------------------------------------
// Word + sentence iterators
// ---------------------------------------------------------------------------

n00b_unicode_break_iter_t *n00b_unicode_word_iter_raw(const char *data, int64_t len) {
  n00b_unicode_break_iter_t *it = n00b_alloc(n00b_unicode_break_iter_t);
  it->data = data;
  it->len = len;
...
n00b_unicode_break_iter_t *n00b_unicode_word_iter(n00b_string_t s) _kargs {
  n00b_allocator_t *allocator = nullptr;
}
{
  (void)allocator; // accepted for API surface
...
n00b_unicode_break_iter_t *n00b_unicode_sentence_iter_raw(const char *data, int64_t len) {
  n00b_unicode_break_iter_t *it = n00b_alloc(n00b_unicode_break_iter_t);
  it->data = data;
  it->len = len;
...
n00b_unicode_break_iter_t *n00b_unicode_sentence_iter(n00b_string_t s) _kargs {
  n00b_allocator_t *allocator = nullptr;
}
{
  (void)allocator; // accepted for API surface
