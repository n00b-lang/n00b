...
n00b_unicode_gc_t n00b_unicode_general_category(n00b_codepoint_t cp) {
  ...
  return (n00b_unicode_gc_t)N00B_UNICODE_LOOKUP(n00b_unicode_gc_stage1, n00b_unicode_gc_stage2, cp);
}
...
n00b_unicode_bidi_class_t n00b_unicode_bidi_class(n00b_codepoint_t cp) {
  ...
  return (n00b_unicode_bidi_class_t)N00B_UNICODE_LOOKUP(n00b_unicode_bidi_stage1,
                                              n00b_unicode_bidi_stage2, cp);
}

n00b_unicode_eaw_t n00b_unicode_east_asian_width(n00b_codepoint_t cp) {
  if (cp >= 0x110000)
    return N00B_UNICODE_EAW_N;
  return (n00b_unicode_eaw_t)N00B_UNICODE_LOOKUP(n00b_unicode_eaw_stage1, n00b_unicode_eaw_stage2,
                                       cp);
}
...
n00b_unicode_jt_t n00b_unicode_joining_type(n00b_codepoint_t cp) {
  ...
  return (n00b_unicode_jt_t)N00B_UNICODE_LOOKUP(n00b_unicode_jt_stage1, n00b_unicode_jt_stage2, cp);
}

bool n00b_unicode_has_property(n00b_codepoint_t cp, n00b_unicode_property_t prop) {
  if (cp >= 0x110000)
    return false;
  uint64_t bits =
...
int n00b_unicode_script_extensions(n00b_codepoint_t cp, n00b_unicode_script_t *scripts,
                              int max_scripts) {
  ...
  const uint32_t *entry = n00b_unicode_sparse_lookup(n00b_unicode_script_ext_index,
                                                ...
                                                n00b_unicode_script_ext_data, cp);
...
n00b_unicode_numeric_type_t n00b_unicode_numeric_type(n00b_codepoint_t cp) {
  ...
  const uint32_t *entry =
      n00b_unicode_sparse_lookup(n00b_unicode_numeric_index, n00b_unicode_numeric_index_len,
                            n00b_unicode_numeric_data, cp);
  if (!entry)
    return N00B_UNICODE_NUMERIC_NONE;
