...
static n00b_codepoint_t simple_map(n00b_codepoint_t cp,
...
n00b_codepoint_t n00b_unicode_toupper_cp(n00b_codepoint_t cp) {
  return simple_map(cp, n00b_unicode_simple_upper_index,
                    n00b_unicode_simple_upper_index_len, n00b_unicode_simple_upper_data);
}

n00b_codepoint_t n00b_unicode_tolower_cp(n00b_codepoint_t cp) {
  return simple_map(cp, n00b_unicode_simple_lower_index,
                    n00b_unicode_simple_lower_index_len, n00b_unicode_simple_lower_data);
}

n00b_codepoint_t n00b_unicode_totitle_cp(n00b_codepoint_t cp) {
  return simple_map(cp, n00b_unicode_simple_title_index,
                    n00b_unicode_simple_title_index_len, n00b_unicode_simple_title_data);
}

n00b_codepoint_t n00b_unicode_casefold_cp(n00b_codepoint_t cp) {
  return simple_map(cp, n00b_unicode_casefold_simple_index,
...
static uint32_t full_map_cp(n00b_codepoint_t cp, const uint32_t index[][2],
                            uint32_t index_len, const uint32_t *data,
                            const uint32_t simple_index[][2],
                            uint32_t simple_index_len,
                            const uint32_t *simple_data, char *buf) {
  ...
  n00b_codepoint_t mapped =
      simple_map(cp, simple_index, simple_index_len, simple_data);
  return n00b_unicode_utf8_encode(mapped, buf);
}

static n00b_string_t
full_case_map(n00b_allocator_t *allocator, const char *data, int64_t len,
              const uint32_t full_index[][2], uint32_t full_index_len,
              const uint32_t *full_data, const uint32_t simple_index[][2],
              uint32_t simple_index_len, const uint32_t *simple_data) {
  ...
  while (pos < (uint32_t)len) {
    ...
    char tmp[16];
    uint32_t n = full_map_cp((n00b_codepoint_t)cp, full_index,
                             full_index_len, full_data, simple_index,
                             simple_index_len, simple_data, tmp);
...
n00b_string_t n00b_unicode_toupper_raw(n00b_allocator_t *allocator, const char *data,
                                  int64_t len, const char *locale) {
  (void)locale; // locale-specific not yet implemented
  return full_case_map(
      allocator, data, len, n00b_unicode_full_upper_index, n00b_unicode_full_upper_index_len,
      n00b_unicode_full_upper_data, n00b_unicode_simple_upper_index,
      n00b_unicode_simple_upper_index_len, n00b_unicode_simple_upper_data);
}

n00b_string_t n00b_unicode_toupper(n00b_string_t s) _kargs {
...
n00b_string_t n00b_unicode_tolower_raw(n00b_allocator_t *allocator, const char *data,
                                  int64_t len, const char *locale) {
  (void)locale;
  return full_case_map(
      allocator, data, len, n00b_unicode_full_lower_index, n00b_unicode_full_lower_index_len,
      n00b_unicode_full_lower_data, n00b_unicode_simple_lower_index,
      n00b_unicode_simple_lower_index_len, n00b_unicode_simple_lower_data);
}

n00b_string_t n00b_unicode_tolower(n00b_string_t s) _kargs {
  n00b_allocator_t *allocator = NULL;
  const char *locale = NULL;
}
{
...
n00b_string_t n00b_unicode_totitle_raw(n00b_allocator_t *allocator, const char *data,
                                  int64_t len, const char *locale) {
  (void)locale;
  ...
  while (pos < (uint32_t)len) {
    ...
    if (at_start) {
      ...
      if (gc == N00B_UNICODE_GC_LU || gc == N00B_UNICODE_GC_LL || gc == N00B_UNICODE_GC_LT) {
        at_start = false;
      }
    } else {
...
n00b_string_t n00b_unicode_totitle(n00b_string_t s) _kargs {
  n00b_allocator_t *allocator = NULL;
  const char *locale = NULL;
}
{
...
n00b_string_t n00b_unicode_casefold_raw(n00b_allocator_t *allocator, const char *data,
                                 int64_t len) {
  char *out = n00b_alloc_array(char, (size_t)len * 12 + 1);
  uint32_t out_pos = 0;
  uint32_t pos = 0;
  ...
  while (pos < (uint32_t)len) {
    ...
    const uint32_t *entry = n00b_unicode_sparse_lookup(
        n00b_unicode_casefold_full_index, n00b_unicode_casefold_full_index_len,
        n00b_unicode_casefold_full_data, (n00b_codepoint_t)cp);
...
n00b_string_t n00b_unicode_casefold(n00b_string_t s) _kargs {
  n00b_allocator_t *allocator = NULL;
}
{
  if (!allocator)
...
int n00b_unicode_casecmp_raw(const char *a, int64_t a_len, const char *b,
                        int64_t b_len) {
