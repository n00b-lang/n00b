...
// Compat: n00b uses n00b_dict_untyped_item_t in iteration.
typedef struct {
    void    *key;
    void    *value;
    uint64_t order;
} n00b_dict_untyped_item_t;
...
_n00b_dict_mask(const n00b_dict_untyped_t *d)
{
    return d->capacity - 1;
}
...
static inline void _n00b_dict_resize(n00b_dict_untyped_t *d, size_t new_cap);

static inline void
_n00b_dict_maybe_resize(n00b_dict_untyped_t *d)
{
...
static inline void
_n00b_dict_resize(n00b_dict_untyped_t *d, size_t new_cap)
{
 ...
 */
static inline void
n00b_dict_untyped_init(n00b_dict_untyped_t *dict,
                       n00b_hash_fn         hash_fn,
                       n00b_dict_key_eq_fn  key_eq)
{
...
{
    bool found;
    _n00b_dict_untyped_get(d, key, &found);

    if (found) {
        return false;
    }

    _n00b_dict_untyped_put(d, key, value);
    return true;
}
...
#define n00b_dict_untyped_get(d, k, b) \
    _n00b_dict_untyped_get(d, ((void *)(uintptr_t)(k)), (b))
...
#define n00b_dict_untyped_remove(d, k) \
    _n00b_dict_untyped_remove(d, ((void *)(uintptr_t)(k)))
 ...
 */
static inline void
n00b_dict_untyped_free(n00b_dict_untyped_t *d)
{
    free(d->buckets);
    d->buckets  = nullptr;
    d->capacity = 0;
