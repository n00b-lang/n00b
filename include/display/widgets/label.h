 ...
 *
 * All rich string styling flows through `n00b_plane_draw_text()`, which
 * appends a draw command carrying the string's styling metadata.
 * Both ANSI and Cocoa backends render the resulting styled text
 * identically.
 *
 * ### Usage
 *
 ...
 * @kw width      Plane width (0 = auto from text width).
 * @kw height     Plane height (0 = auto, 1 unless wrap).
