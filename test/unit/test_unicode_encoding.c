...
TEST(test_str_from_cstr)
{
    ...
    n00b_string_t s2 = n00b_string_from_cstr("\xE6\x97\xA5\xE6\x9C\xAC");
...
TEST(test_str_copy)
{
    n00b_string_t s = n00b_string_from_cstr("test");
...
TEST(test_next_cp)
{
    n00b_string_t s   = n00b_string_from_cstr("A\xC3\xA9\xE4\xB8\x96");
    uint32_t      pos = 0;
...
{
    n00b_string_t s = n00b_string_from_cstr("Hello \xE4\xB8\x96\xE7\x95\x8C \xF0\x9F\x98\x80");
...
{
    n00b_string_t s = n00b_string_from_cstr("ABC\xC3\xA9\xE4\xB8\x96");
    n00b_array_t(uint16_t) u16 = n00b_unicode_to_utf16(s);
    ASSERT(u16.data != nullptr);
...
TEST(test_utf16_surrogate_pairs)
{
    ...
    n00b_string_t s = n00b_string_from_cstr("\xF0\x9F\x98\x80");
    n00b_array_t(uint16_t) u16 = n00b_unicode_to_utf16(s);
    ASSERT(u16.data != nullptr);
    ASSERT_EQ(u16.len, 2);
...
{
    n00b_string_t s = n00b_string_from_cstr("Test \xE6\x97\xA5\xE6\x9C\xAC");
...
{
    // "Aé世😀" = 4 codepoints
    n00b_string_t s = n00b_string_from_cstr("A\xC3\xA9\xE4\xB8\x96\xF0\x9F\x98\x80");
    n00b_array_t(n00b_codepoint_t) u32 = n00b_unicode_to_utf32(s);
    ASSERT(u32.data != nullptr);
    ASSERT_EQ(u32.len, 4);
