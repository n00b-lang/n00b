...
{
    n00b_unicode_idna_result_t r = n00b_unicode_idna_to_ascii(n00b_string_from_cstr("example.com"), .allocator = nullptr);
...
TEST(test_unicode_domain)
{
    ...
    n00b_unicode_idna_result_t r = n00b_unicode_idna_to_ascii(n00b_string_from_cstr("m\xC3\xBCnchen.de"), .allocator = nullptr);
    ASSERT_EQ(r.error, N00B_UNICODE_IDNA_OK);
...
{
    n00b_unicode_idna_result_t r = n00b_unicode_idna_to_unicode(n00b_string_from_cstr("example.com"), .allocator = nullptr);
    ASSERT_EQ(r.error, N00B_UNICODE_IDNA_OK);
    ASSERT_STR_EQ(r.value.data, "example.com");
}
...
TEST(test_zwj_after_virama)
{
    ...
    n00b_unicode_idna_result_t r = n00b_unicode_idna_to_ascii(
        n00b_string_from_cstr("\xE0\xA4\x95\xE0\xA5\x8D\xE2\x80\x8D\xE0\xA4\x95.example.com"),
        .allocator = nullptr);
    ASSERT_EQ(r.error, N00B_UNICODE_IDNA_OK);
...
TEST(test_zwj_invalid)
{
    ...
    n00b_unicode_idna_result_t r = n00b_unicode_idna_to_ascii(
        n00b_string_from_cstr("a\xE2\x80\x8D" "b.com"),
        .allocator = nullptr);
...
TEST(test_zwnj_joining_context)
{
    ...
    n00b_unicode_idna_result_t r = n00b_unicode_idna_to_ascii(
        n00b_string_from_cstr("\xD8\xA8\xE2\x80\x8C\xD8\xA8.example.com"),
        .allocator = nullptr);
    ASSERT_EQ(r.error, N00B_UNICODE_IDNA_OK);
    ASSERT(r.value.u8_bytes > 0);
}
...
TEST(test_zwnj_invalid)
{
    ...
    n00b_unicode_idna_result_t r = n00b_unicode_idna_to_ascii(
        n00b_string_from_cstr("a\xE2\x80\x8C" "b.com"),
        .allocator = nullptr);
    ASSERT_EQ(r.error, N00B_UNICODE_IDNA_CONTEXTJ_ERROR);
}
...
TEST(test_middle_dot_valid)
{
    ...
    n00b_unicode_idna_result_t r = n00b_unicode_idna_to_ascii(
        n00b_string_from_cstr("l\xC2\xB7l.com"),
        .allocator = nullptr);
    ASSERT_EQ(r.error, N00B_UNICODE_IDNA_OK);
    ASSERT(r.value.u8_bytes > 0);
}
...
TEST(test_middle_dot_invalid)
{
    ...
    n00b_unicode_idna_result_t r = n00b_unicode_idna_to_ascii(
        n00b_string_from_cstr("a\xC2\xB7" "b.com"),
        .allocator = nullptr);
...
TEST(test_arabic_digit_mix)
{
    ...
    n00b_unicode_idna_result_t r = n00b_unicode_idna_to_ascii(
        n00b_string_from_cstr("\xD9\xA0\xDB\xB0.com"),
        .allocator = nullptr);
    ASSERT_EQ(r.error, N00B_UNICODE_IDNA_CONTEXTO_ERROR);
}
...
TEST(test_hebrew_geresh)
{
    ...
    n00b_unicode_idna_result_t r = n00b_unicode_idna_to_ascii(
        n00b_string_from_cstr("\xD7\x90\xD7\xB3.com"),
        .allocator = nullptr);
    ASSERT_EQ(r.error, N00B_UNICODE_IDNA_OK);
    ASSERT(r.value.u8_bytes > 0);
}
