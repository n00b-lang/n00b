...
TEST(test_cat)
{
    n00b_string_t c = n00b_unicode_str_cat(n00b_string_from_cstr("Hello"), n00b_string_from_cstr(" World"), .allocator = nullptr);
...
TEST(test_cat_many)
{
    n00b_string_t raw[] = { n00b_string_from_cstr("a"), n00b_string_from_cstr("b"), n00b_string_from_cstr("c") };
...
TEST(test_join)
{
    n00b_string_t raw[] = { n00b_string_from_cstr("one"), n00b_string_from_cstr("two"), n00b_string_from_cstr("three") };
    n00b_array_t(n00b_string_t) parts = n00b_array_checked_ptr(n00b_string_t, 3, raw);
    parts.len = 3;
    n00b_string_t r = n00b_unicode_str_join(n00b_string_from_cstr(", "), parts, .allocator = nullptr);
...
{
    n00b_string_t sl = n00b_unicode_str_slice(n00b_string_from_cstr("Hello"), 0, 3, .allocator = nullptr);
...
{
    n00b_string_t sl = n00b_unicode_str_slice(n00b_string_from_cstr("Hello"), -2, 5, .allocator = nullptr);
...
TEST(test_slice_multibyte)
{
    ...
    n00b_string_t cafe = n00b_string_from_cstr("caf\xC3\xA9");
...
{
    n00b_string_t g = n00b_unicode_str_grapheme_at(n00b_string_from_cstr("abc"), 1, .allocator = nullptr);
...
{
    n00b_string_t sl = n00b_unicode_str_slice_bytes(n00b_string_from_cstr("Hello World"), 6, 11, .allocator = nullptr);
...
TEST(test_find)
{
    auto r1 = n00b_unicode_str_find(n00b_string_from_cstr("Hello World"), n00b_string_from_cstr("World"));
    ASSERT(n00b_option_is_set(r1));
    ASSERT_EQ(n00b_option_get(r1), 6);

    auto r2 = n00b_unicode_str_find(n00b_string_from_cstr("Hello World"), n00b_string_from_cstr("xyz"));
    ASSERT(!n00b_option_is_set(r2));
}

TEST(test_rfind)
{
    auto r = n00b_unicode_str_find(n00b_string_from_cstr("abcabc"), n00b_string_from_cstr("abc"), .reverse = true);
...
TEST(test_contains)
{
    ASSERT(n00b_unicode_str_contains(n00b_string_from_cstr("Hello World"), n00b_string_from_cstr("World")));
    ASSERT(!n00b_unicode_str_contains(n00b_string_from_cstr("Hello World"), n00b_string_from_cstr("xyz")));
}

TEST(test_starts_ends_with)
{
    ASSERT(n00b_unicode_str_starts_with(n00b_string_from_cstr("Hello World"), n00b_string_from_cstr("Hello")));
    ASSERT(!n00b_unicode_str_starts_with(n00b_string_from_cstr("Hello World"), n00b_string_from_cstr("World")));
    ASSERT(n00b_unicode_str_ends_with(n00b_string_from_cstr("Hello World"), n00b_string_from_cstr("World")));
    ASSERT(!n00b_unicode_str_ends_with(n00b_string_from_cstr("Hello World"), n00b_string_from_cstr("Hello")));
}

TEST(test_replace)
{
    n00b_string_t r = n00b_unicode_str_replace(n00b_string_from_cstr("Hello World"), n00b_string_from_cstr("World"), n00b_string_from_cstr("Earth"),
                                       .allocator = nullptr);
...
{
    n00b_string_t r = n00b_unicode_str_replace_all(n00b_string_from_cstr("aXbXc"), n00b_string_from_cstr("X"), n00b_string_from_cstr("--"),
                                           .allocator = nullptr);
...
{
    n00b_string_t r = n00b_unicode_str_replace_all(n00b_string_from_cstr("aXXbXXc"), n00b_string_from_cstr("XX"), n00b_string_from_cstr("Y"),
                                           .allocator = nullptr);
...
TEST(test_split)
{
    n00b_array_t(n00b_string_t) parts = n00b_unicode_str_split(n00b_string_from_cstr("one,two,three"), n00b_string_from_cstr(","),
                                                                .allocator = nullptr);
...
{
    n00b_array_t(n00b_string_t) lines = n00b_unicode_str_split_lines(n00b_string_from_cstr("a\nb\r\nc\rd"),
                                                                      .allocator = nullptr);
...
TEST(test_trim)
{
    n00b_string_t t = n00b_unicode_str_trim(n00b_string_from_cstr("  hello  "), .allocator = nullptr);
...
TEST(test_trim_unicode_whitespace)
{
    ...
    n00b_string_t t = n00b_unicode_str_trim(n00b_string_from_cstr("\xE2\x80\x83hi\xC2\xA0"), .allocator = nullptr);
...
TEST(test_cmp)
{
    ASSERT(n00b_unicode_str_cmp(n00b_string_from_cstr("abc"), n00b_string_from_cstr("abd")) < 0);
    ASSERT(n00b_unicode_str_cmp(n00b_string_from_cstr("abd"), n00b_string_from_cstr("abc")) > 0);
    ASSERT_EQ(n00b_unicode_str_cmp(n00b_string_from_cstr("abc"), n00b_string_from_cstr("abc")), 0);
}
...
TEST(test_cmp_normalized)
{
    ...
    ASSERT(n00b_unicode_str_cmp(n00b_string_from_cstr("e\xCC\x81"), n00b_string_from_cstr("\xC3\xA9")) != 0);
    // With NFC normalization they are equal.
    ASSERT_EQ(n00b_unicode_str_cmp(n00b_string_from_cstr("e\xCC\x81"), n00b_string_from_cstr("\xC3\xA9"),
                                    .normalize = true), 0);
    // Case-insensitive ordering.
    ASSERT_EQ(n00b_unicode_str_cmp(n00b_string_from_cstr("Hello"), n00b_string_from_cstr("hello"),
                                    .case_sensitive = false), 0);
}

TEST(test_eq)
{
    ASSERT(n00b_unicode_str_eq(n00b_string_from_cstr("hello"), n00b_string_from_cstr("hello")));
    ASSERT(!n00b_unicode_str_eq(n00b_string_from_cstr("hello"), n00b_string_from_cstr("world")));
}

TEST(test_eq_nfc)
{
    // Decomposed é (e + combining acute) vs precomposed é
    ASSERT(!n00b_unicode_str_eq(n00b_string_from_cstr("e\xCC\x81"), n00b_string_from_cstr("\xC3\xA9")));
    ASSERT(n00b_unicode_str_eq_nfc(n00b_string_from_cstr("e\xCC\x81"), n00b_string_from_cstr("\xC3\xA9")));
}

TEST(test_eq_casefold)
{
    ASSERT(!n00b_unicode_str_eq(n00b_string_from_cstr("Hello"), n00b_string_from_cstr("hello")));
    ASSERT(n00b_unicode_str_eq_casefold(n00b_string_from_cstr("Hello"), n00b_string_from_cstr("hello")));
}

TEST(test_pad_right)
{
    n00b_string_t r = n00b_unicode_str_pad_right(n00b_string_from_cstr("hi"), 5, .allocator = nullptr, .fill = ' ');
    ASSERT_STR_EQ(r.data, "hi   ");
}

TEST(test_pad_left)
{
    n00b_string_t r = n00b_unicode_str_pad_left(n00b_string_from_cstr("42"), 5, .allocator = nullptr, .fill = '0');
    ASSERT_STR_EQ(r.data, "00042");
}

TEST(test_center)
{
    n00b_string_t r = n00b_unicode_str_center(n00b_string_from_cstr("hi"), 6, .allocator = nullptr, .fill = '-');
    ASSERT_STR_EQ(r.data, "--hi--");
}

TEST(test_truncate)
{
    n00b_string_t r = n00b_unicode_str_truncate(n00b_string_from_cstr("Hello World"), 8,
...
TEST(test_repeat)
{
    n00b_string_t r = n00b_unicode_str_repeat(n00b_string_from_cstr("ab"), 3, .allocator = nullptr);
...
{
    n00b_string_t r = n00b_unicode_str_repeat(n00b_string_from_cstr("abc"), 0, .allocator = nullptr);
    ASSERT_STR_EQ(r.data, "");
    ASSERT_EQ(r.u8_bytes, 0);
}
...
{
    n00b_string_t r = n00b_unicode_str_reverse(n00b_string_from_cstr("abcde"), .allocator = nullptr);
...
TEST(test_reverse_multibyte)
{
    ...
    n00b_string_t r = n00b_unicode_str_reverse(n00b_string_from_cstr("caf\xC3\xA9"), .allocator = nullptr);
...
TEST(test_reverse_combining)
{
    ...
    n00b_string_t r = n00b_unicode_str_reverse(n00b_string_from_cstr("ae\xCC\x81"), .allocator = nullptr);
...
{
    n00b_array_t(n00b_string_t) parts = n00b_unicode_str_split_graphemes(n00b_string_from_cstr("abc"),
                                                                          .allocator = nullptr);
    ASSERT_EQ(parts.len, 3);
...
{
    n00b_string_t r = n00b_unicode_str_escape(n00b_string_from_cstr("hello"), .allocator = nullptr);
    ASSERT_STR_EQ(r.data, "hello");
}

TEST(test_escape_backslash_and_quotes)
{
    n00b_string_t r = n00b_unicode_str_escape(n00b_string_from_cstr("a\\b\"c"), .allocator = nullptr);
    ASSERT_STR_EQ(r.data, "a\\\\b\\\"c");
}

TEST(test_escape_control_chars)
{
    n00b_string_t r = n00b_unicode_str_escape(n00b_string_from_cstr("a\nb\t"), .allocator = nullptr);
...
TEST(test_escape_hex)
{
    ...
    n00b_string_t r = n00b_unicode_str_escape(n00b_string_from_cstr("\x01"), .allocator = nullptr);
...
{
    auto r = n00b_unicode_str_unescape(n00b_string_from_cstr("a\\nb\\t"), .allocator = nullptr);
...
{
    auto r = n00b_unicode_str_unescape(n00b_string_from_cstr("\\x41"), .allocator = nullptr);
    ASSERT(n00b_result_is_ok(r));
    n00b_string_t s = n00b_result_get(r);
    ASSERT_STR_EQ(s.data, "A");
}
...
{
    // \u00E9 = é
    auto r = n00b_unicode_str_unescape(n00b_string_from_cstr("\\u00e9"), .allocator = nullptr);
    ASSERT(n00b_result_is_ok(r));
    n00b_string_t s = n00b_result_get(r);
...
{
    auto r = n00b_unicode_str_unescape(n00b_string_from_cstr("\\xGG"), .allocator = nullptr);
    ASSERT(n00b_result_is_err(r));
}

TEST(test_unescape_truncated)
{
    auto r = n00b_unicode_str_unescape(n00b_string_from_cstr("\\u00"), .allocator = nullptr);
    ASSERT(n00b_result_is_err(r));
}

TEST(test_escape_unescape_roundtrip)
{
    n00b_string_t orig    = n00b_string_from_cstr("hello\nworld\t\"test\"\\end");
...
{
    auto r = n00b_unicode_str_codepoint_at(n00b_string_from_cstr("abc"), 1);
    ASSERT(n00b_option_is_set(r));
...
{
    // "café" — é is U+00E9
    auto r = n00b_unicode_str_codepoint_at(n00b_string_from_cstr("caf\xC3\xA9"), 3);
    ASSERT(n00b_option_is_set(r));
...
{
    auto r = n00b_unicode_str_codepoint_at(n00b_string_from_cstr("abc"), 10);
    ASSERT(!n00b_option_is_set(r));
}

TEST(test_codepoint_at_empty)
{
    auto r = n00b_unicode_str_codepoint_at(n00b_string_from_raw("", 0), 0);
    ASSERT(!n00b_option_is_set(r));
}
...
TEST(test_split_and_crop)
{
    n00b_array_t(n00b_string_t) parts = n00b_unicode_str_split_and_crop(
        n00b_string_from_cstr("hello,world,foobar"), n00b_string_from_cstr(","), 4, .allocator = nullptr);
    ASSERT_EQ(parts.len, 3);
...
{
    n00b_array_t(n00b_string_t) lines = n00b_unicode_str_wrap(n00b_string_from_cstr("hi"),
                                                               .width = 80);
...
{
    n00b_array_t(n00b_string_t) lines = n00b_unicode_str_wrap(n00b_string_from_raw("", 0),
                                                               .width = 80);
...
TEST(test_wrap_hard_break)
{
    ...
    n00b_array_t(n00b_string_t) lines = n00b_unicode_str_wrap(
        n00b_string_from_cstr("abcdefghij"), .width = 5);
...
TEST(test_wrap_no_hard_break)
{
    ...
    n00b_array_t(n00b_string_t) lines = n00b_unicode_str_wrap(
        n00b_string_from_cstr("abcdefghij"), .width = 5, .no_hard_wrap = true);
    ASSERT_EQ(n00b_array_len(lines), 1);
...
TEST(test_wrap_hang)
{
    ...
    n00b_array_t(n00b_string_t) lines = n00b_unicode_str_wrap(
        n00b_string_from_cstr("hello world"), .width = 7, .hang = 2);
