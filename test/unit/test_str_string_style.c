...
TEST(test_no_styling_by_default)
{
    ...
    ASSERT(n00b_str_get_style_info(s) == nullptr);
}
...
TEST(test_set_base_style)
{
    ...
    n00b_string_style_info_t *info = n00b_str_get_style_info(s2);
    ASSERT(info != nullptr);
...
TEST(test_strip_styles)
{
    ...
    n00b_string_t s2 = n00b_str_set_base_style(s, st);
    ASSERT(n00b_str_get_style_info(s2) != nullptr);

    n00b_string_t s3 = n00b_str_strip_styles(s2);
    ASSERT(n00b_str_get_style_info(s3) == nullptr);
