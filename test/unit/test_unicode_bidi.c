...
TEST(test_ltr_text)
{
    n00b_unicode_bidi_para_t *p = n00b_unicode_bidi_open(n00b_string_from_cstr("Hello"));
...
{
    n00b_unicode_bidi_para_t *p = n00b_unicode_bidi_open(n00b_string_from_cstr("\xD9\x85\xD8\xB1\xD8\xAD\xD8\xA8\xD8\xA7"));
