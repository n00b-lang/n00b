...
{
    n00b_string_t nfc = n00b_unicode_nfc(STR("e\xCC\x81"), .allocator = NULL);
...
{
    n00b_string_t nfd = n00b_unicode_nfd(STR("\xC3\xA9"), .allocator = NULL);
...
{
    n00b_string_t nfc = n00b_unicode_nfc(STR("Hello"), .allocator = NULL);
...
{
    n00b_string_t nfkc
        = n00b_unicode_nfkc(STR("\xEF\xAC\x81"), .allocator = NULL); // ﬁ ligature
    ASSERT_STR_EQ(nfkc.data, "fi");
}

TEST(test_nfkd_compat)
{
    n00b_string_t nfkd = n00b_unicode_nfkd(STR("\xEF\xAC\x81"), .allocator = NULL);
    ASSERT_STR_EQ(nfkd.data, "fi");
}

TEST(test_hangul_decompose_compose)
{
    n00b_string_t nfd = n00b_unicode_nfd(STR("\xED\x95\x9C"), .allocator = NULL);
    ASSERT_EQ(nfd.codepoints, 3);

    n00b_string_t nfc = n00b_unicode_nfc(nfd, .allocator = NULL);
...
{
    n00b_string_t nfd = n00b_unicode_nfd(STR("e\xCC\xA7\xCC\x81"), .allocator = NULL);
...
run_normalization_conformance(void)
{
    ...
    while (fgets(line, sizeof(line), f)) {
        ...
        {
            n00b_string_t r1 = n00b_unicode_nfc(s[0], .allocator = NULL);
            n00b_string_t r2 = n00b_unicode_nfc(s[1], .allocator = NULL);
            n00b_string_t r3 = n00b_unicode_nfc(s[2], .allocator = NULL);
        ...
        {
            n00b_string_t r4 = n00b_unicode_nfc(s[3], .allocator = NULL);
            n00b_string_t r5 = n00b_unicode_nfc(s[4], .allocator = NULL);
        ...
        {
            n00b_string_t r1 = n00b_unicode_nfd(s[0], .allocator = NULL);
            n00b_string_t r2 = n00b_unicode_nfd(s[1], .allocator = NULL);
            n00b_string_t r3 = n00b_unicode_nfd(s[2], .allocator = NULL);
        ...
        {
            n00b_string_t r4 = n00b_unicode_nfd(s[3], .allocator = NULL);
            n00b_string_t r5 = n00b_unicode_nfd(s[4], .allocator = NULL);
        ...
        {
            for (int i = 0; i < 5; i++) {
                n00b_string_t r = n00b_unicode_nfkc(s[i], .allocator = NULL);
        ...
        {
            for (int i = 0; i < 5; i++) {
                n00b_string_t r = n00b_unicode_nfkd(s[i], .allocator = NULL);
