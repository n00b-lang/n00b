...
{
    ASSERT(n00b_unicode_is_valid_identifier(STR("hello")));
    ASSERT(n00b_unicode_is_valid_identifier(STR("hello_world")));
    ASSERT(!n00b_unicode_is_valid_identifier(STR("123")));
    ASSERT(!n00b_unicode_is_valid_identifier(STR("")));
}
